...
--
-- Host: 127.0.0.1
-- Czas generowania: 04 Gru 2023, 03:04
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `CheckSurnameOrders` (IN `last_name` VARCHAR(30) CHARSET utf8)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `deleteUser` (IN `input_id` INT)   DELETE FROM `users` WHERE id = input_id$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `EditBook` (IN `input_id` INT, IN `input_category` VARCHAR(50) CHARSET utf8, IN `input_title` VARCHAR(50) CHARSET utf8, IN `input_author` VARCHAR(50) CHARSET utf8, IN `input_publisher` VARCHAR(50) CHARSET utf8, IN `input_year` YEAR, IN `input_pages` INT, IN `input_price` DOUBLE, IN `input_description` TEXT, IN `input_img` VARCHAR(255))   UPDATE `books` 
SET `category`= input_category,`title`= input_title ,`author`= input_author, `publisher`= input_publisher, `year`= input_year,
`pages`= input_pages,`price`= input_price,`description`= input_description, `img`= input_img 
WHERE id = input_id$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `getAllOrders` ()   SELECT * 
FROM orders$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `getAllUsers` ()   SELECT * 
From users$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `getUserOrders` (IN `input_id` INT)   SELECT * FROM `orders` WHERE user_id = input_id$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `setOrderStatus` (IN `input_id` INT, IN `newStatus` VARCHAR(50) CHARSET utf8)   UPDATE `orders` SET `status`= newStatus WHERE id = input_id$$
...
CREATE DEFINER=`root`@`localhost` FUNCTION `OrderStatus` (`order_id` INT) RETURNS VARCHAR(255) CHARSET utf8mb4 COLLATE utf8mb4_polish_ci  BEGIN
...
(1, 2, 'Bohaterów Getta Warszawskiego', '23', '42-500', 'Będzin'),
(2, 3, 'Pieniężnego', '116', '10-006', 'Olsztyn'),
(3, 4, 'Zgierska', '146', '91-059', 'Łódź'),
(4, 5, 'Usługowa', '60', '92-647', 'Łódź'),
(5, 6, 'Rynek', '33', '04-397', 'Warszawa'),
(6, 7, 'Dietla', '4', '33-380', 'Krynica-Zdrój'),
(7, 8, 'Mochnackiego Maurycego', '98', '20-452', 'Lublin');
...
(2, 3, 'Pieniężnego Seweryna', '112', '10-006', 'Olsztyn'),
(5, 6, 'Kickiego Ludwika', '72', '04-397', 'Warszawa'),
(5, 6, 'Rynek', '3', '04-397', 'Warszawa');
...
(1, 2, '2023-12-04', 117.97, 'Zakończono'),
(2, 2, '2023-12-04', 49.99, 'Zakończono'),
(3, 3, '2023-12-04', 417.89, 'Wysłano'),
(4, 4, '2023-12-04', 27.99, 'Wysyłka'),
(5, 5, '2023-12-04', 81.96, 'Realizacja'),
(6, 7, '2023-12-04', 75.98, 'Oczekujący'),
(7, 7, '2023-12-04', 145.97, 'Anulowano'),
(8, 7, '2023-12-04', 233.95, 'Wysyłka'),
(9, 8, '2023-12-04', 39.99, 'Wysłano'),
(10, 8, '2023-12-04', 24.99, 'Realizacja'),
(11, 8, '2023-12-04', 49.99, 'Zakończono'),
(12, 8, '2023-12-04', 62.98, 'Oczekujący');
...
(1, 1, 71, 1, 45.99, 45.99),
(2, 1, 69, 2, 35.99, 71.98),
(3, 2, 100, 1, 49.99, 49.99),
(4, 3, 55, 3, 27.99, 83.97),
(5, 3, 60, 1, 28.99, 28.99),
(6, 3, 82, 1, 44.99, 44.99),
(7, 3, 4, 1, 54.99, 54.99),
(8, 3, 81, 1, 42.99, 42.99),
(9, 3, 45, 1, 19.99, 19.99),
(10, 3, 84, 1, 45.99, 45.99),
(11, 3, 96, 2, 47.99, 95.98),
(12, 4, 55, 1, 27.99, 27.99),
(13, 5, 50, 1, 16.99, 16.99),
(14, 5, 41, 1, 18.99, 18.99),
(15, 5, 46, 1, 23.99, 23.99),
(16, 5, 49, 1, 21.99, 21.99),
(17, 6, 76, 1, 42.99, 42.99),
(18, 6, 34, 1, 32.99, 32.99),
(19, 7, 19, 1, 42.99, 42.99),
(20, 7, 99, 1, 47.99, 47.99),
(21, 7, 17, 1, 54.99, 54.99),
(22, 8, 31, 1, 41.99, 41.99),
(23, 8, 16, 1, 44.99, 44.99),
(24, 8, 97, 3, 48.99, 146.97),
(25, 9, 1, 1, 39.99, 39.99),
(26, 10, 48, 1, 24.99, 24.99),
(27, 11, 100, 1, 49.99, 49.99),
(28, 12, 52, 1, 29.99, 29.99),
(29, 12, 34, 1, 32.99, 32.99);
...
(1, 'admin', 'admin', 'admin', 'admin@czytelno.com', '$2y$10$YDuLlEko8uH83lEBGgktBuNlCBcKqOOdAmFQfNrvOc9fxaHorg43C'),
(2, 'Maciejo23', 'Filip', 'Maciejewski', 'Maciej@op.pl', '$2y$10$kPx.KbMDZWDpyChLUaxzy.GJCU4Ymg8zelJXdjU.IJJmUun3R9Ld6'),
(3, 'Emanu90', 'Emanuel', 'Szulc', 'Emane@gmail.com', '$2y$10$m1zS8f925DaF1Ut0v77mfe0b8eYx5IIEe2obvFz0Bax4iYloMxtMa'),
(4, 'Kowal13', 'Bartłomiej', 'Kowalski', 'Kowal13@wp.pl', '$2y$10$uJQCA7YexVBJrNrlCH8rJey78.blTyNfMXVzHd4fPYVo.xEid1svG'),
(5, 'Jasia55', 'Oliwia', 'Jasińska', 'Jasiek@poczta.pl', '$2y$10$VSMMTJWdZ2TlJJ5qXJZT9e/LAvYKHo9WPZgFnWUe0qFOVCBNuGJDC'),
(6, 'Vadim01', 'Piotr', 'Fundament', 'Vadim01@op.p', '$2y$10$OLxocdfdvh1yXg1ZLr9g7ei5bvNO0y8GeeoImb5JPDu.IPw9ubg2G'),
(7, 'Baranowa45', 'Ewelina', 'Baran', 'Baran@gmail.com', '$2y$10$PptRGWw7U3wotdhQu5jRpumTikZSHKh2093MZDiWhnVz4rpe2Qz12'),
(8, 'Wandal33', 'Wanda ', 'Przybylska', 'Wandal@gmail.com', '$2y$10$fzLcI99lg5YOw2fglQLk0OkiUUZmzJigdtXtCzOVIwjTFbXjTNcLW');
